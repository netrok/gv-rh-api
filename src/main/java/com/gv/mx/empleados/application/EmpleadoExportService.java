...
public class EmpleadoExportService {
    ...
    public List<ExportEmpleadoRow> getRows(String q, Long departamentoId, Long puestoId, Boolean activo) {
        List<ExportEmpleadoProjectionWithNames> data =
                repo.findForExport(q, departamentoId, puestoId, activo);
    ...
    public byte[] toXlsx(List<ExportEmpleadoRow> rows) throws Exception {
    ...
    public byte[] toPdf(List<ExportEmpleadoRow> rows) throws Exception {
